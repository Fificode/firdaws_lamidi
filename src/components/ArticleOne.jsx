...
const ArticleOne = ({header, articleimage, explanation, stackone}) => {
  return (
    <div>
  ...
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://medium.com/@lamidifirdaws/most-common-methods-of-sending-and-receiving-data-in-javascript-f4ef9b7ddffc" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">View article</a>
