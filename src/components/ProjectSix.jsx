...
const ProjectSix = ({header, stackone, stackthree, stacksix, stacktwo, explanation, projectimage}) => {
  return (
    <div className="flex flex-col-reverse xl:flex-row-reverse items-center justify-center">
      <div className="flex flex-col items-center m-[10px] flex-[100%] max-w-full" >
        ...
        <div className="flex my-[10px]">
          <img src={stackone} alt="HTML logo" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] mx-1" /><img src={stacktwo} alt="CSS logo" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] mx-1" />
          <img src={stackthree} alt="Javascript logo" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] mx-1" />
          <img src={stacksix} alt="Vue js logo" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] mx-1" />
        </div>
        <div className="">
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://fificode-weight-tracker.netlify.app" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">Visit website</a>
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
  <a href="https://github.com/Fificode/vue-weight-tracker" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">View code</a>
