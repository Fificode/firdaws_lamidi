...
const ProjectSix = ({header, stackthree, stacksix, stacktwo, explanation, projectimage}) => {
  return (
    <div className="flex flex-col-reverse xl:flex-row-reverse items-center justify-center">
      <div className="flex flex-col items-center m-[10px] flex-[100%] max-w-full" >
        ...
        <img src={stacksix} alt="Next js logo" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] mx-1" />
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://accessories-hub.netlify.app/" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">Visit website</a>
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
  <a href="https://github.com/Fificode/accessories-hub" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">View code</a>
