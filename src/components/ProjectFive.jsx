...
const ProjectFive = ({header, stackone, stackthree, stacktwo, explanation, projectimage}) => {
  return (
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://fificode.github.io/NIMSA-journal/" className="text-center text-[14px] md:text-[17px]">Visit website</a>
     <div className="mx-[3px]"> <svg className="w-[20px] h-[15px] md:w-[25px] md:h-[25px]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
  <a href="https://github.com/Fificode/NIMSA-journal" className="text-center text-[14px] md:text-[17px]">View code</a>
