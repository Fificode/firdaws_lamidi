...
const ArticleThree = ({header, articleimage, explanation, stackone}) => {
  return (
    <div>
         <div className="flex flex-col-reverse xl:flex-row items-center justify-center my-[40px]">
  ...
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://medium.com/@lamidifirdaws/how-to-build-a-weather-app-with-react-js-using-current-location-and-search-location-4650d2607f67" target='_blank' rel="noreferrer" className="text-center text-[14px] md:text-[17px]">View article</a>
