...
<ul className="flex justify-between mt-[20px] list-none">
  <li className="px-[5px]"><a href="https://github.com/Fificode" target='_blank' rel="noreferrer">  <img src={github} alt="Github icon" className="fill-black w-[20px] h-[20px] md:w-[30px] md:h-[30px]" /></a></li>
  <li className="px-[5px]"><a href="https://www.linkedin.com/in/firdaws-lamidi-840b57200/" target='_blank' rel="noreferrer">  <img src={linkedin} alt="Linkedin icon" className="fill-black w-[20px] h-[20px] md:w-[30px] md:h-[30px]" /></a></li>
