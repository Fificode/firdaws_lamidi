    ...
    <div className="bg-grey p-[20px]" id="about">
      ...
      <div className="flex justify-center">
        <main className="text-center tracking-[0.0015em] leading-[29px] text-[18px] md:text-[22px] font-[400] text-light-black p-[5px] md:p-[30px]">
          ...
          <p className="py-[10px]">I'm super excited you're here. Feel free to <a href="https://wa.me/2349022629258" className="text-cognac"> reach out to me </a>with any project ideas you have or to just say hello!</p>
        </main>
      </div>
      </div>
    </div>
